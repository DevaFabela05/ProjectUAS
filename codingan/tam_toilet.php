            ...
            <form method="post" action="tam_toilet.php" enctype="multipart/form-data">
                ...
                <div class="input">
                    ...
                    <select class="form-select" aria-label="Default select example" name="lokasi">
                        <option value=""></option>
                        <option value="Office">Lobby 1</option>
                        <option value="Office">Lobby 2</option>
                        <option value="Factory 1">Fasos 1</option>
                        <option value="Factory 2">Fasos 2</option>
                        <option value="Security">Lv 1</option>
                        <option value="Office">Lv 2</option>
                        <option value="Office">Ecc 1</option>
                        <option value="Office">Ecc 2</option>
                        <option value="Office">Pos 1</option>
                        <option value="Office">Pos 2</option>
                    </select>
                </div>
                <div class="input">
